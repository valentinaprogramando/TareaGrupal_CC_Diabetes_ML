...

{
  ...
  "probabilidad_calculada": 0.12,
  "nivel_alerta": "BAJA",
  "mensaje_clinico": "No se detectan patrones de riesgo significativos.",
  "factores_de_riesgo": [
    "No se detectan factores de riesgo individuales críticos."
  ]
}
...
Request (JSON):
{
  ...
  "physical_activity_minutes_per_week": 20
}
...
Response (JSON):
{
  ...
  "probabilidad_calculada": 0.71,
  "nivel_alerta": "ALTA",
  "mensaje_clinico": "El modelo detecta patrones clínicos consistentes con diabetes.",
  "factores_de_riesgo": [
    "HbA1c Crítica (6.9%) - Rango diabético.",
    "Glucosa Ayunas Alta (145 mg/dL).",
    "Obesidad (IMC: 31.2)."
  ]
}
